...
<head>
    ...
    <title>¿Quiénes somos? | NutriKids</title>
    ...
    <style>
        ...
        .menu li a[href="{{ route("conocenos") }}"] {
        ...
        .texto-conocenos, .mision-conocenos {
        ...
        .texto-conocenos p, .mision-conocenos p {
            color: #34495e;
            line-height: 1.8;
            font-size: 1.1em;
            margin-bottom: 20px;
...
<body>
            ...
            <div class="header-top">
                ...
                <nav class="menu">
                    <ul>
                        ...
                        <li><a href="{{ route("conocenos") }}" class="active">¿Quiénes Somos?</a></li>
    ...
    <section class="seccion-conocenos">
        <div class="contenido-conocenos">
            <h2>CONÓCENOS</h2>
            <div class="grid-conocenos">
                <div class="texto-conocenos">
                    <p>NutriKids nace en 2023 como un proyecto universitario. El objetivo desde el primer día ha sido informar a los padres de familia acerca de la obesidad infantil en México y de esta manera aportar a la lucha por disminuir el índice de padecimientos.</p>
                    <p>A través de nuestra página usted como padre de familia podrá orientarse acerca de la buena alimentación de sus hijos. Contamos con la colaboración profesional de la nutrióloga Sandra Olmos, con quien usted podrá contactarse, tener seguimiento directo y personalizado.</p>
                </div>
                <div class="mision-conocenos">
                    <h3>¿Quiénes somos?</h3>
                    <p>NutriKids somos una página web informativa sobre nutrición infantil, enfocados en niños de 0 a 15 años y buscamos aportar nuestro granito de arena para disminuir el índice de obesidad infantil en México.</p>
                </div>
            </div>
        </div>
    </section>
