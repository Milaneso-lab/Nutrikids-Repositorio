...
function cargarDiscusiones() {
    ...
    .catch(error => {
        ...
        const container = document.getElementById('discussions-list');
        container.innerHTML = '<p class="error-loading">No se pudieron cargar las discusiones. Inténtalo de nuevo.</p>';
    });
}
...
if (discussionForm) {
    discussionForm.addEventListener('submit', function(e) {
        ...
        .catch(error => {
            ...
            mensajeErrorDiscusion.textContent = 'No se pudo completar la acción. Inténtalo de nuevo.';
            mensajeErrorDiscusion.style.display = 'block';
